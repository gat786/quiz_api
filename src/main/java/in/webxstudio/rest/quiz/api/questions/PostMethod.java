...
public class PostMethod {
	...
	public String postMultiple(Multiple getSuggestion) {
		...
		sender.sendSuggestion(postedQuestion.getQuestion(), postedQuestion.getOption1(),  postedQuestion.getOption2(),  postedQuestion.getOption3(),  postedQuestion.getAnswer(),postedQuestion.getSubject());		
		return "Post Works";
	}
